...
<html lang="TR">
    <head>
        <title>İletişim | HİTİD (HLA İmmünogenetiği ve Transplantasyon İmmünolojisi Derneği)</title>
        ...
        <main>
                    ...
                    <div class="container">
                        <div class="page-title-wrap text-center w-100">
                            <div class="page-title-inner d-inline-block">
                                <h1 class="mb-0">İletişim Bilgilerimiz</h1>
                            </div>
                        </div><!-- Page Title Wrap -->
                    </div>
                </div>
            ...
            <section>
                <div class="w-100 pt-100 thm-layer opc6 pb-30 position-relative">
                    <div class="fixed-bg back-blend-lighten thm-bg" style="background-image: url();"></div>
                    <div class="container">
                        <div class="sec-title3 text-center w-100">
                            <div class="sec-title3-inner d-inline-block">
                                <h3 class="mb-0">HLA İmmünogenetiği ve Transplantasyon İmmünolojisi Derneği</h3>
                            </div>
                        </div>
                            ...
                            <div class="row mrg30 justify-content-center">
                                <div class="col-md-4 col-sm-6 col-lg-4">
                                    <div class="contact-info-box position-relative w-100">
                                        ...
                                        <p class="mb-0">Adres:<br>Aksaray Mah. İnkılap Cad. Koşar Han. No:16 İç Kapı 204 Fatih/ İSTANBUL</p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-lg-4">
                                    <div class="contact-info-box position-relative w-100">
                                        <i class="fas fa-envelope-open brd-rd10 d-inline-block scndry-clr"></i>
                                        <span class="d-block">E-Posta:<br><a href="mailto:info@hitid.org" title="">info@hitid.org</a></span>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="contact-form d-flex flex-wrap justify-content-center text-center w-100">
                            <form class="w-100" id="email-form">
                                ...
                                <div class="field-box w-100"><input class="brd-rd10 fname" type="text" name="fname" placeholder="Adınız" required></div>
                                <div class="field-box w-100"><input class="brd-rd10 email" type="email" name="email" placeholder="E-Posta Adresiniz" required></div>
                                <div class="field-box w-100"><input class="brd-rd10 subject" type="tel" name="subject" placeholder="Konu" required></div>
